...
(tela) #instância da classe Principal, passamos a variável tela como parâmetro
...
tela.mainloop() #método obrigatório para carregar a tela e para que os eventos ocorram#Método para verificar senha
